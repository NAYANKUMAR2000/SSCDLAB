...
for(i=0;i<n;i++)	// to calculate the wait time and turnaround time ofeach process
	{
...
printf("\n\n Process name\t Arrival time\t Burst time\t Waiting time \tFinishing time \tturnaround time Tr/Tb\n");
